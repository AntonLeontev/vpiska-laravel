...
<table id="ko_onecolumnBlock_1" width="100%" cellspacing="0" cellpadding="0" border="0">
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            <tbody><tr>
                                <td>
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        <tbody><tr>
                                            <td class="padding-copy" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #3F3D33; padding-top: 0px" align="center">Благодарим за регистрацию<br></td>
                                        </tr>
                                        <tr>
                                            <td class="padding-copy textlightStyle" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #3F3D33" align="center"><p style="margin: 0px;">Для подтверждения электронной почты нажмите на кнопку ниже.</p></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
...
</tbody></table><table id="ko_titleBlock_1" width="100%" cellspacing="0" cellpadding="0" border="0">
    <tbody>
    <tr class="row-b">
        <td class="section-padding" style="padding: 30px 15px 0px 15px" bgcolor="#EDE8DA" align="center">
            <table style="padding: 0 0 20px 0" class="responsive-table" width="500" cellspacing="0" cellpadding="0" border="0">
                <!-- TITLE -->
                <tbody><tr>
                    <td class="padding-copy textlightStyle" colspan="2" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #3F3D33" align="center"><p style="margin: 0px;">{{$link}}</p></td>
                </tr>
            </tbody></table>
        </td>
    </tr>
